...
/**
* Create a DeepFilterNet Model using the model baked into this wasm binary
* at compile time (the "default-model" feature) — avoids shipping/fetching
* the ~7.6MB model tar.gz as a separate file in the browser.
*
* Args:
*     - atten_lim: Attenuation limit in dB.
*
...
* @returns {number}
*/
export function df_create_default(atten_lim) {
