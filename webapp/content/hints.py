# -*- coding: utf-8 -*-
"""Многоступенчатые подсказки к заданиям (курированный контент — 0, 81..150).
...
# показываются как заглушки до наполнения контентом, а 81..150 — уже с
...
HINTED_TASK_IDS: Iterable[int] = [0, *range(1, 151)]
